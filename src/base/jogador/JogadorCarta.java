...
public class JogadorCarta extends Jogador {
	...
	/**
	 * JAVADOC Parte de escolher a cor, agora, sem sem aleatório
	 */
	...
	/**
	 * JAVADOC Parte de Definir Carta da Jogada
	 */
	...
	protected Carta defineCartaDaJogada() {
		...
		for (Carta c : this.maoJogador.getCartas()) {
			...
			if (ca.getCor() == corUltimaCarta
					|| (ultimo instanceof CartaEspecialComCor && ca.getAcao() == acaoUltimaCarta)) {
				return ca;
			}
		}
