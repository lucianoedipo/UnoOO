...
public class JogadorJogador extends Jogador {
	...
	/**
	 * Construtor que recebe o nome do JogadorJogador e utiliza o construtor da
	 * classe SUPER (Jogador) para instanciar o objeto.
	 * 
	...
	/**
	 * Classe que retorna a cor mais possuida pelo jogador, ou 'null'.
	 * 
	 * @see Jogador
	 * @see Cor
	...
	/**
	 * @Override Realiza a seleção de uma cor para realizar a ação de troca de cor.
	 *           Seleciona-se a cor em maior quantidade na MaoCartas de
	 *           JogadorJogador, ou uma cor aleatória. A cor aleatória é obtida a
	 *           partir do método sorteiaCor da classe Jogador.
	 * 
	...
	protected Carta defineCartaDaJogada() {
		...
		if (cartaComMesmoNumero != null)
			return cartaComMesmoNumero;
